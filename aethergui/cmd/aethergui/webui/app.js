...
function renderAbout() {
  ...
  $('#abCorePath').textContent = v.corePath || '—';
  $('#abBackend').textContent = v.backend || '—';
  $('#abData').textContent = v.dataDir || '—';
  $('#abLog').textContent = v.logFile || '—';
}
...
function bind() {
  ...
  $('#abOpenData').onclick = () => api('/api/system/reveal', { path: S.version.dataDir });
